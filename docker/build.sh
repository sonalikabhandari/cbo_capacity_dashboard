...
docker stop cbointake-django cbointake-celery cbointake-beat
docker rm cbointake-django cbointake-celery cbointake-beat
...
scp static.tgz 98.7.156.13:/usr/share/nginx/html/sre/cbo-intake/static && \
ssh 98.7.156.13 "cd /usr/share/nginx/html/sre/cbo-intake/static; tar xzf static.tgz; cd ..; chmod 755 static -R"
